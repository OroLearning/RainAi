      ...
      <div className={`relative w-full max-w-md bg-white rounded-[44px] shadow-heavy p-10 border border-slate-100 overflow-hidden transition-all duration-500 ease-out transform ${animate ? 'scale-100 translate-y-0' : 'scale-90 translate-y-12'}`}>
        ...
        <div className="relative z-10">
          ...
          <p className="text-center text-slate-400 text-sm font-medium mb-8 px-4">
            {view === 'signup' 
              ? 'Create an account to access the RAIN engine.' 
              : view === 'login' 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {view === 'signup' && (
              <div className="space-y-1 animate-fade-in-up">
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold text-slate-800 focus:bg-white focus:border-blue-400 focus:outline-none transition-all duration-300 shadow-inner"
                />
              </div>
            )}
              ...
              <div className="space-y-1">
                ...
                <div className="relative group/input">
                  <input 
                    ...
                    placeholder="••••••••"
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 pl-6 pr-14 text-sm font-bold text-slate-800 focus:bg-white focus:border-blue-400 focus:outline-none transition-all duration-300 shadow-inner"
                  />
                  <button
                    type="button"
            ...
            <button 
              type="submit"
              className="w-full bg-slate-900 hover:bg-blue-600 text-white font-black text-xs uppercase tracking-[0.2em] py-5 rounded-2xl shadow-xl shadow-slate-200 transition-all duration-300 active:scale-95 mt-4 group"
            >
